...
# Highly cited logistic regression 
...
coef_labels <- list(
  "(Intercept)"               = "Intercept",
  "R35_groupNIGMS MIRA"               = "Funded by NIGMS MIRA",
  ...
  "R35_groupNIGMS MIRA:Science_TypeMixed" = "NIGMS MIRA X Mixed",
  "R35_groupNIGMS MIRA:Science_TypeHuman-focused" = "NIGMS MIRA X Human-focused",
...
htmlreg(
  ...
  digits = 3,
  caption = "",
  file="Supplemental Table 7.html",
  caption.above = TRUE,
)
